...
export const CogIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15.75 0H1.5M21 12c0 .879-.089 1.734-.258 2.56M19.5 4.5l-.83.83M12 3V1.5m0 21V21m0-1.846A7.5 7.5 0 0012 21c4.142 0 7.5-3.358 7.5-7.5S16.142 6 12 6s-7.5 3.358-7.5 7.5c0 .356.025.705.072 1.046M4.5 19.5l.83-.83m13.34 0l-.83-.83" />
  </svg>
);
...
export const ClipboardDocumentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 011.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 00-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 4.625v2.625m0 0H19.5m-2.25-2.625a1.125 1.125 0 011.125-1.125H21a1.125 1.125 0 011.125 1.125v2.625M15.75 17.25v-2.625a1.125 1.125 0 00-1.125-1.125H12a1.125 1.125 0 00-1.125 1.125v2.625" />
  </svg>
);
...
export const CompressIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 9.75L4.5 4.5M4.5 4.5h5.25M4.5 4.5v5.25m9.75 9.75l5.25 5.25M19.5 19.5h-5.25M19.5 19.5v-5.25" />
  </svg>
);
